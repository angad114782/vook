...
const suites = [
  { role: 'SUPER ADMIN', routes: ['/dashboard', '/companies', '/subscriptions', '/plans', '/payments', '/activity', '/modules', '/support', '/settings', '/integrations', '/audit', '/security', '/platform-employees', '/notifications-admin', '/notifications'] },
  ...
  { role: 'HR', routes: ['/hr/dashboard', '/hr/notifications', '/hr/employees', '/hr/attendance', '/hr/leaves', '/hr/approvals', '/hr/payroll', '/hr/documents', '/hr/settings'] },
  { role: 'FINANCE', routes: ['/finance/dashboard', '/finance/notifications', '/finance/payroll', '/finance/salary-structure', '/finance/payslips', '/finance/expenses', '/finance/reports', '/finance/settings'] },
  { role: 'MANAGER', routes: ['/manager/dashboard', '/manager/notifications', '/manager/workforce', '/manager/approvals', '/manager/attendance', '/manager/reports', '/manager/settings'] },
  { role: 'SUPERVISOR', routes: ['/supervisor/dashboard', '/supervisor/notifications', '/supervisor/workforce', '/supervisor/attendance', '/supervisor/shifts', '/supervisor/approvals', '/supervisor/settings'] },
  { role: 'EMPLOYEE', routes: ['/employee/dashboard', '/employee/notifications', '/employee/attendance', '/employee/leaves', '/employee/payslips', '/employee/expenses', '/employee/documents', '/employee/settings'] },
] as const;
