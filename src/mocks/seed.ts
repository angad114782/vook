...
export const createMockSeed = (now = new Date()): MockState => {
  ...
  return {
    ...
    attendanceIntegrations: [
      { id: "attendance_connection_mobile", companyId: "company_northstar", providerKey: "MOBILE_GEOLOCATION", displayName: "Employee mobile GPS", connectionMode: "MOBILE", status: "ACTIVE", publicConfig: {}, deviceSerials: [], secretConfigured: false, lastTestedAt: daysFrom(now, -5), createdAt: daysFrom(now, -20) },
    ],
    workflows: [
      {
        type: "leave",
