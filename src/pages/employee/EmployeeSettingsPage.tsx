...
interface Profile {
  ...
  // The employee profile endpoint populates the account relation as `userId`.
  // Keep `user` as an optional compatibility field for any legacy payloads.
...
export default function EmployeeSettingsPage() {
  ...
  const profileUser = profile?.user ?? profile?.userId ?? user ?? null;

  useEffect(() => {
    if (profileUser && !formInit) {
      setEditName(profileUser.name ?? "");
      setEditEmail(profileUser.email ?? "");
      setFormInit(true);
    }
  }, [profileUser, formInit]);
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <div>
        ...
        <p style={{ fontSize: "13px", color: "#64748b", marginTop: "2px" }}>
          Manage your profile, bank details, and account security
        </p>
      </div>
        ...
        <div style={{ padding: "24px" }}>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <input
                    value={fmtDate(profile?.joiningDate ?? null)}
                    readOnly
                    style={readonlyStyle}
                  />
                </div>
          ...
          {tab === "Bank Details" && (
            ...
            >
              ...
              >
                Bank details are read-only. Contact HR to update your bank
                information.
              </div>
              <div
                style={{
              ...
              >
                ...
                <div>
                  ...
                  <input value="—" readOnly style={readonlyStyle} />
                </div>
              </div>
            </div>
          )}
                  ...
                  <button
                    onClick={async () => {
                      ...
                      try {
                        ...
                        toast.error(
                          extractError(err, "Failed to update password"),
                        );
                      }
                    }}
                    style={{
