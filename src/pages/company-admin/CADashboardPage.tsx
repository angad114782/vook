...
export default function CADashboardPage() {
  ...
  const STATS = [
    ...
    },
    {
      ...
      color: "#ea580c",
      bg: "#fff7ed",
      sub: `${100 - attendancePct}% absent`,
    },
    {
      label: "Pending Approvals",
      value: pendingLeaves + pendingExpenses,
      color: "#0d7470",
      bg: "#f0fdfa",
      sub: "Requires action",
    },
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
      {dashData?.onboarding && dashData.onboarding.status !== "COMPLETED" && (
        <div
          ...
          style={{
            ...
            alignItems: "center",
            gap: 14,
            borderLeft: "4px solid #0d7470",
          }}
        >
          <div style={{ flex: 1 }}>
            <strong style={{ fontSize: 13 }}>Finish company setup</strong>
            <p style={{ fontSize: 11, color: "#64748b", marginTop: 4 }}>
              {
                dashData.onboarding.steps.filter((step) =>
                  ["COMPLETED", "SKIPPED"].includes(step.status),
                ).length
              }{" "}
              of {dashData.onboarding.steps.length} steps complete. Policies,
              roles, and invitations can be finished at any time.
            </p>
          </div>
          <button
            className="admin-button"
            onClick={() => navigate("/company-admin/onboarding")}
          >
            Continue setup
          </button>
        </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => navigate("/company-admin/workforce")}
              style={{
                fontSize: "11px",
                color: "#0d7470",
                fontWeight: 600,
        ...
        >
          {[
            ...
            },
            {
              label: "Manage Roles",
              icon: Shield,
              path: "/company-admin/settings/roles",
            },
            {
